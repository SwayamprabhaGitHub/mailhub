    ...
    <div className="flex items-center justify-between mx-3 h-16">
      <div className="flex items-center gap-10">
        <div className="flex items-center gap-6">
          <div className="p-3 rounded-full hover:bg-gray-200 cursor-pointer transition-all duration-1000 ease-in-out">
      ...
      <div className="md:block hidden w-[50%]">
        <div className="flex items-center bg-[#EAF1FB] px-1 py-1 rounded-full focus-within:bg-white">
          <div className="flex items-center w-9 h-9 justify-center rounded-full hover:bg-gray-300 cursor-pointer transition-all duration-1000 ease-in-out">
