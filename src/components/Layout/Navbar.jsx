    ...
    <div className="flex items-center justify-between mx-3 h-16">
      ...
      <div className="md:block hidden w-[50%] relative search-container">
        <div className="flex justify-center items-center w-full">
          <div className="flex items-center bg-teal-300/30 px-1 py-1 rounded-full focus-within:bg-white focus-within:shadow-lg transition-all duration-300 ease-in-out w-[60%] focus-within:w-[100%]">
            <div className="flex items-center w-9 h-9 justify-center rounded-full hover:bg-rose-300/30 cursor-pointer transition-all duration-300 ease-in-out">
